...
city_day_df['City'] = city_day_df['City'].str.lower()  # Standardize city names to lowercase
...
weather_df['clean_name'] = weather_df['name'].str.split(',').str[0].str.strip().str.lower()
weather_df.loc[weather_df['clean_name'] == 'brajarajnagar', 'clean_name'] = 'brajrajnagar'
